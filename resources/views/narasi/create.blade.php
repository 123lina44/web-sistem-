        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form class="row g-3" action="{{ route('narasi.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                      <div class="col-12 mb-4">
                          <label for="">Narasi</label>
                          <textarea name="narasi" id="editor" cols="30" rows="10">{{ old('narasi') }}</textarea>
                      </div>
