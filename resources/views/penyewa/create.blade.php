        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form class="row g-3" action="{{ route('penyewa.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                      <div class="col-md-6 mb-2">
                          <label class="form-label" for="">Nama Penyewa<abbr title="" style="color: black">*</abbr></label>
                          <input type="text" class="form-control" placeholder="Masukkan penyewa disini...." name="penyewa" value="{{ old('penyewa') }}">
                      </div>
                      <div class="col-md-6 mb-2">
                          <label class="form-label" for="">No Kamar <abbr title="" style="color: black">*</abbr></label>
                          <select name="id_kamar" id="" class="form-control">
                            <option value="">Pilih Nomor Kamar Yang Disewa</option>
