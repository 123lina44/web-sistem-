        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form class="row g-3" action="{{ route('datakamar.update', $kamar->id_kamar) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                      <div class="col-md-6 mb-2">
                          <label class="form-label" for="">Nomor Kamar<abbr title="" style="color: black">*</abbr></label>
                          <input type="number" class="form-control" placeholder="Masukkan Nomor Kamar disini...." name="no_kamar" value="{{ $kamar->no_kamar}}">
                      </div>
                      <div class="col-md-6 mb-2">
                          <label class="form-label" for="">Biaya Kamar Perbulan <abbr title="" style="color: black">*</abbr></label>
                          <input type="number" class="form-control" placeholder="Masukkan Biaya Kamar Perbulan disini...." name="harga" value="{{ $kamar->harga}}">
                      </div>
                      <div class="col-md-6 mb-2">
                          ...
                          <select name="ukuran_kamar" id="" class="form-control">
                            <option @if ($kamar->ukuran_kamar == $kamar->ukuran_kamar)
                                selected
                            @endif value="{{$kamar->ukuran_kamar}}">{{$kamar->ukuran_kamar}}</option>
                      ...
                      <div class="col-md-6 mb-2">
                          ...
                          <input type="number" class="form-control" placeholder="Masukkan Maksimal Orang disini...." name="jumlah_max_kamar" value="{{ $kamar->jumlah_max_kamar}}">
                      </div>
                      <div class="col-md-6 mb-2">
                          <label class="form-label" for="">Status Kamar <abbr title="" style="color: black">*</abbr></label>
                          <select name="status" id="" class="form-control">
                            <option @if ($kamar->status == $kamar->status)
                                selected
                            @endif value="{{$kamar->status}}">{{$kamar->status}}</option>
                      ...
                      <div class="col-12 mb-4">
                          ...
                          <textarea name="deskripsi" id="editor" cols="30" rows="10">{{ $kamar->deskripsi }}</textarea>
                      </div>
